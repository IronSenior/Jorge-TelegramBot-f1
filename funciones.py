...
def crear_comp(competition):
	...
	cursor.execute('''INSERT INTO COMPETICIONES (ID, NAME) VALUES (%i, %s)''' %(chat_id, name))
...
def add_player(chat_id, player):
	...
	print "Dentro de la Base de datos 2"
